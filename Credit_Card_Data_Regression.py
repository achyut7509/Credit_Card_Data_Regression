...
credit_card_dataset['Bill_amt_1']           = credit_card_dataset['Bill_amt_1'].astype(int)
credit_card_dataset['Bill_amt_2']           = credit_card_dataset['Bill_amt_2'].astype(int)
credit_card_dataset['Bill_amt_3']           = credit_card_dataset['Bill_amt_3'].astype(int)
credit_card_dataset['Bill_amt_4']           = credit_card_dataset['Bill_amt_4'].astype(int)
credit_card_dataset['Bill_amt_5']           = credit_card_dataset['Bill_amt_5'].astype(int)
credit_card_dataset['Bill_amt_6']           = credit_card_dataset['Bill_amt_6'].astype(int)
credit_card_dataset['Pay_amt_1']            = credit_card_dataset['Pay_amt_1'].astype(int)
credit_card_dataset['Pay_amt_2']            = credit_card_dataset['Pay_amt_2'].astype(int)
credit_card_dataset['Pay_amt_3']            = credit_card_dataset['Pay_amt_3'].astype(int)
credit_card_dataset['Pay_amt_4']            = credit_card_dataset['Pay_amt_4'].astype(int)
credit_card_dataset['Pay_amt_5']            = credit_card_dataset['Pay_amt_5'].astype(int)
credit_card_dataset['Pay_amt_6']            = credit_card_dataset['Pay_amt_6'].astype(int)
credit_card_dataset['Default_next_month_payment']            = credit_card_dataset['Default_next_month_payment'].astype(int)

    ## RECHECK DATATYPES

data_dtypes_recheck = credit_card_dataset.dtypes
